...
from apps.openapi.agent.analysis_componet.data_model import DataModel, Measure, SiblingGroup, SiblingGroupContainer
...
if __name__ == "__main__":
    ...
    print(json.dumps(OutstandingFirstInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(OutstandingLastInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(AttributionInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(EvennessInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(TrendInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(CorrelationInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
    print(json.dumps(ChangePointInsightType.from_data(subspaces[0], threshold=0.0, debug=True).model_dump(),
                     ensure_ascii=False))
